...
Across sites, the RF model explained 83% of observed variance ($r^{2}$) when evaluated against out-of-bag data. Based on the variable importance rankings, $SO_{4}^{2-}$ concentration was the dominant predictor of FCH4 (Figure [-@fig-VarImp]a), indicating that the significant difference in $SO_{4}^{2-}$ concentration across sites (Table [-@tbl-WQ]) was the dominant factor explaining the significant differences in FCH4 across sites. However, other water quality variables, including DOC, pH and NO3/NO2 along with WTD were also in the top 5 top predictors of FCH4 across sites.

Within sites, water quality parameters were also the dominant predictors of FCH4 at Hogg and Young, with $SO_{4}^{2-}$ being the top predictor at Hogg (Figure [-@fig-VarImp]c) and TP being the dominant predictor at Young (Figure [-@fig-VarImp]b). While water quality variables and WTD were the top predictors at Hogg and across sites, TA and GPP were also among the top predictors at Young. 
![Variable importance.](../figures/VarImp_all.png){#fig-VarImp}
